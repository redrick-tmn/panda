...
namespace PandaWebApp.Engine.Binders
{
    ...
    public class EditPromouterToUsers : BaseBinder<Promouter, PromouterUser>
    {
        public override void Load(Promouter source, PromouterUser dest)
        {
            ...
            if (checklist == null)
            {
                ...
                {
                    User = new PromouterUser { Id = source.UserId }
                };
            }
            ...
            if (source.MainAlbum != null && source.MainAlbum.Photos != null)
            {
                dest.Album = source.MainAlbum.Photos.Select(x => x.SourceUrl);
            }
            else
            {
                dest.Album = new string[0];
            }
